    ...
    >
      <div className="relative aspect-[4/5] overflow-hidden rounded-[24px] bg-[#fcfaf8]">
        ...
        <button
          ...
          className="absolute right-3 top-3 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-white/70 backdrop-blur-md transition-all hover:bg-white hover:scale-110"
        >
          <Heart
            size={16}
            className={
      ...
      <div className="mt-4 px-1 pb-2 text-center">
        ...
        {category && (
          <p className="text-[10px] text-[#b4a79e] mb-1">
            {category}
          </p>
        )}

        <Link href={`/product/${id}`}>
          <h3 className="text-[14px] font-medium text-[#4a4846] line-clamp-1 hover:text-[#ff8fa3]">
            {name}
          </h3>
        </Link>
        ...
        <div className="mt-1.5 flex items-center justify-center gap-1">
          ...
          <span className="text-[9px] font-bold text-[#b4a79e]">
            تومان
          </span>
        </div>
